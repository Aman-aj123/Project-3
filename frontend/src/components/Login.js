...
const Login = () => {
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               ...
               toast.error("Some error occurs while login !", {
                    position: 'top-center',
                    autoClose: 3000
               });
                         ...
                         <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                              ...
                              <form onSubmit={handleSubmit} className="md:space-y-3" action="#">
                                   ...
                                   <div>
                                        ...
                                        <input value={password} onChange={handleChange} type="password" name="password" id="password" className="bg-gray-50 border h-[40px] border-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full  focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" required={true} />
                                   </div>
